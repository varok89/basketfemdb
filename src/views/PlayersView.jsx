      ...
      <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:"12px"}}>
        <div style={{display:"flex",gap:"8px",alignItems:"center"}}>
          <button onClick={()=>{
            ...
            trackEv("share_click",{tipo:"jugadora",id:selected.id_jugadora,canal:navigator.share?"nativo":"clipboard"});
                            ...
                            <div>
                              <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",gap:"6px",flexWrap:"wrap"}}>
                                ...
                                {isAdmin&&!isCoach&&<div style={{display:"flex",gap:"4px"}} onClick={e=>e.stopPropagation()}>
                                  ...
                                  <button onClick={()=>{setEditSeason(s);setModal("editSeason");}} aria-label="Editar temporada" style={{background:"var(--fx-hover)",border:"none",borderRadius:"6px",padding:"3px 8px",fontSize:"11px",cursor:"pointer",color:"var(--fx-label)"}}>✏️</button>
